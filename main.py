...
"""Ask the user if he has reserved a table, and if not, assign him a table based on availability. 
There should be a certain number of tables, 1 for single, double and family size."""




"""After assigning a table, show the number of free and reserved/occupied tables. 
For a reserved table, you can specify the name and time of reservation."""




""""Then show different menu options for breakfast, lunch, dinner and drinks. 
Include a special menu for vegetarians and vegans. Each menu item must have the following attributes: 
weight, preparation time in minutes, calories and price."""




"""Allow the user to change the order before payment. This means they should be able to add, 
delete or update the amount of the same order as per their choice."""




"""Show the final order summary to the user, including the menu items selected, the total amount due,
 and the approximate wait time for the food to be served."""




"""Add an option for the user to add a tip as a percentage of the total price to the final bill. 
And ask whether the payment will be in cash or by credit card."""



"""After making the payment, generate a receipt by registering the transaction data."""